...
public class WorldProviderOrbitDeimos extends WorldProviderOrbit{
	...
	{
		return SpaceStationsMain.deimosSpaceStation;
	}
	...
	{
		return "DIM_SPACESTATION_Deimos_" + this.spaceStationDimensionID;
	}
