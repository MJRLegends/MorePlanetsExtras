...
public class WorldProviderOrbitKoentus extends WorldProviderOrbit{
	...
	{
		return SpaceStationsMain.koentusSpaceStation;
	}
	...
	{
		return "DIM_SPACESTATION_Koentus_" + this.spaceStationDimensionID;
	}
