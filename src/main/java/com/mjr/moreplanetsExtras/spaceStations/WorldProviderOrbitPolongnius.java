...
public class WorldProviderOrbitPolongnius extends WorldProviderOrbit{
	...
	{
		return SpaceStationsMain.polongniusSpaceStation;
	}
	...
	{
		return "DIM_SPACESTATION_Polongnius_" + this.spaceStationDimensionID;
	}
