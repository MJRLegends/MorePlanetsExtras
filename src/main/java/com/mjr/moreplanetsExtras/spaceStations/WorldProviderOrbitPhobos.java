...
public class WorldProviderOrbitPhobos extends WorldProviderOrbit{
	...
	{
		return SpaceStationsMain.phobosSpaceStation;
	}
	...
	{
		return "DIM_SPACESTATION_Phobos_" + this.spaceStationDimensionID;
	}
