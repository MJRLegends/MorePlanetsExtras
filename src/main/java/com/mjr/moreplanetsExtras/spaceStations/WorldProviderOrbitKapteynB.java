...
public class WorldProviderOrbitKapteynB extends WorldProviderOrbit {
	@Override
	public CelestialBody getCelestialBody() {
		return SpaceStationsMain.kapteynBSpaceStation;
	}
	...
	public String getSaveFolder() {
		return "DIM_SPACESTATION_KapteynB_" + this.spaceStationDimensionID;
	}
