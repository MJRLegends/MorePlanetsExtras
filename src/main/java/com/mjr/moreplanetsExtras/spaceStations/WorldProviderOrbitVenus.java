...
public class WorldProviderOrbitVenus extends WorldProviderOrbit{
	...
	{
		return SpaceStationsMain.venusSpaceStation;
	}
	...
	{
		return tier >= ((Planet) GalaxyRegistry.getCelestialBodyFromUnlocalizedName("planet.venus")).getTierRequirement();
	}
