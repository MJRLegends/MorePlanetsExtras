...
public class WorldProviderOrbitFronos extends WorldProviderOrbit {
	...
	public CelestialBody getCelestialBody() {
		return SpaceStationsMain.fronosSpaceStation;
	}
	...
	public String getSaveFolder() {
		return "DIM_SPACESTATION_Fronos_" + this.spaceStationDimensionID;
	}
