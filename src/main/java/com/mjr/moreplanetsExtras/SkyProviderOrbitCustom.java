...
public class SkyProviderOrbitCustom extends IRenderHandler {

	public int starGLCallList = GLAllocation.generateDisplayLists(3);
	public int glSkyList;
	public int glSkyList2;
	private final ResourceLocation planetToRender;
	private final ResourceLocation sunToRender;
	...
	public SkyProviderOrbitCustom(ResourceLocation planet, ResourceLocation sun) {
		this.planetToRender = planet;
		this.sunToRender = sun;
		GL11.glPushMatrix();
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		var12 = 28.0F;
		this.minecraft.renderEngine.bindTexture(this.sunToRender);
		var23.startDrawingQuads();
		 ...
		 * 
		 * // if (this.minecraft.thePlayer.ridingEntity != null) { var25 = this.minecraft.thePlayer.posY - 64;
		 * 
		 ...
		 * 
		 * if (this.minecraft.theWorld.provider.isSkyColored()) { GL11.glColor3f(0.0f, 0.0f, 0.0f); } else { GL11.glColor3f(var3, var4, var5); } GL11.glColor3f(0.0f, 0.0f, 0.0f);
		 * 
