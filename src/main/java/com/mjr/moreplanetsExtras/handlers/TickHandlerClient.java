			...
			if (world != null) {
				if (world.provider instanceof WorldProviderOrbitMercury) {
					if (world.provider.getSkyRenderer() == null) {
						world.provider.setSkyRenderer(new SkyProviderOrbitCustom(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/mercury.png"), new ResourceLocation(GalacticraftCore.ASSET_PREFIX,
								"textures/gui/planets/orbitalsun.png")));
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitMercury) world.provider).getSpinManager().getSpinRate();
					...
					if (world.provider.getSkyRenderer() == null) {
						world.provider.setSkyRenderer(new SkyProviderOrbitCustom(new ResourceLocation("galacticraftcore:textures/gui/celestialbodies/venus.png"), new ResourceLocation(GalacticraftCore.ASSET_PREFIX,
								"textures/gui/planets/orbitalsun.png")));
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitVenus) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitPluto) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitDiona) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitFronos) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitNibiru) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitPolongnius) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitSiriusB) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
					...
					if (world.provider.getSkyRenderer() == null) {
						...
						((SkyProviderOrbitCustom) world.provider.getSkyRenderer()).spinDeltaPerTick = ((WorldProviderOrbitKapteynB) world.provider).getSpinManager().getSpinRate();
						GCPlayerStatsClient.get(player).inFreefallFirstCheck = false;
					}
