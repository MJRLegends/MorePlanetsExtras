...
@Mod(modid = Constants.modID, name = Constants.modName, version = Constants.modVersion, dependencies = "required-after:GalacticraftCore;required-after:GalacticraftPlanets;required-after:moreplanets;", acceptedMinecraftVersions="[1.8.9]")
